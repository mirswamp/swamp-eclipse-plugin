...
To import, follow these steps:
	...
	. Download the archive from the SWAMP releases page
	. In your Eclipse installation directory, copy the plug-in archive (".jar") into the "dropins" directory.
	. Launch Eclipse. You should see the SWAMP icon in the toolbar and the SWAMP menu in the menubar.
...
image:images/menuAndToolbar.png[Menubar and Toolbar]
